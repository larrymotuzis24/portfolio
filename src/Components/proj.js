        ...
        <div className="flex-col items-center justify-between mb-4">
          <div>
            ...
            <div className="flex items-center mt-2 mb-2">
              ...
              <p className="text-white text-sm">Tech Stack: {work.techStack}</p>
            </div>
          </div>
          {
            work.video ? (<div>
              ...
              <div target="_blank" rel="noreferrer" href={work.to}>
              <a className="rounded-md" target="_blank" rel="noreferrer" href={work.to}> {work.to} </a>
            </div>
            )
          }
        ...
        <div className="flex-col items-center justify-between mb-4">
          <div>
            ...
            <div className="flex items-center mt-2 mb-2">
              ...
              <p className="text-white text-sm">Tech Stack: {proj.techStack} </p>
            </div>
          </div>
          <div>
